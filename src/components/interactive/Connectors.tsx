...
function ConnectorPath({ d, scale }: { d: string; scale: MotionValue }) {
  return (
    <motion.path d={d} stroke="white" strokeOpacity="0.1" strokeWidth="2" initial={{ pathLength: 0 }} pathLength={scale} />
  );
}
